...
Owner = "Sam"
print("Initializing Annie")
engine = pyttsx3.init('sapi5')
voices = engine.getProperty('voices')
engine.setProperty('voice',voices[1].id)

#for making Annie say its getting iinitialized !!############################
...
speak("Initializing. Annie...Designed by Data Champions...")

#basic etiquettes for Annie like goodmorning ################################
...
def wishme():
    ...
    speak("I am Annie. How may i help you sir?")
    
    #main use of Annie and giving input to her #################
...
elif "Subhas sir" in query.lower():
    
    speak("Subash sir is the faculty handling Competitive proffessional skills, and is one of the greatest faculty advisors of the class of G1. He is well versed in many computer languages like C, C++, Python")
    
elif "subhash sir" in query.lower():
